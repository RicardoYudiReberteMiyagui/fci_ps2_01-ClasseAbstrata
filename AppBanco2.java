...
public class AppBanco2 {
    private static ContaEspecial[] contas = 
        { new ContaEspecial("Ana", 1000.00, 500.00),
          new ContaEspecial("Bob", 800.00, 400.00),
          new ContaEspecial("Charles", 450.00, 250.00) };
    ...
    public static void main(String[] args) {
        ...
        while (!sair) {
            ...
            print("(4) Aumentar limite em todas");
            print("(5) Sair");
    ...
    private static void  opcaoAumentarLimite(){
        ...
        for (int i=0; i<contas.length; i++) {
            contas[i].aumentarLimite(v);
            print("\n## Limite aumentado na conta de " 
                + contas[i].getNomeCorrentista() + "!");        
        }
    }
